...
import 'package:omegatron/customer/screen/safetynet_model.dart';

class SafetynetProvider extends ChangeNotifier {
  SafetynetModel safetynetModelDetails = SafetynetModel(
    bondsValue: 100000,
    fdValue: 100000,
    metalValue: 100000,
  ...
  getsafetynetModelDetails() async {
    notifyListeners();
  }
}
